...
//       )}
//     >
//       <div className="w-full pl-40 pr-20">
//         <div className="flex h-16 items-center justify-between">
//         <div className="flex items-center gap-4"> {/* Adjust spacing with gap-x */}
//   <SidebarTrigger />
//   <a className="flex items-center" href="/">
//     <div className="flex items-center space-x-2 group">
//       <div className="bg-blue-50 dark:bg-blue-900/20 p-2 rounded-lg">
//         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-text h-6 w-6 text-blue-600 dark:text-blue-400 transition-colors group-hover:text-blue-700">
  ...
  return (
    ...
    >
      <div className="w-full pl-8 pr-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            <SidebarTrigger  className="mr-8 bg-red-400" />
            <Link href="/" className="flex items-center">
              <div className="flex items-center space-x-2 group">
                <motion.div
                  whileHover={{ rotate: 360, scale: 1.1 }}
            ...
            >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button 
                    variant="ghost" 
                    className="rounded-full p-0 hover:bg-transparent focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-all duration-200"
                  >
                    <Avatar className="h-9 w-9 border-2 border-primary/20 transition-all duration-300 hover:border-primary/40 hover:shadow-md">
                      {session?.user?.image && (
                        <AvatarImage 
                          src={session.user.image} 
                          alt={session.user.name || "User"}
                ...
                <DropdownMenuContent 
                  align="end" 
                  className="w-56 p-2 bg-background/95 backdrop-blur-lg border border-border/40 shadow-lg"
                >
                  {session?.user?.name && (
                    <div className="px-2 py-1.5 mb-2">
                  ...
                  <motion.div variants={dropdownItemVariants} whileHover="hover">
                    <DropdownMenuItem 
                      className="flex items-center gap-2 p-2 cursor-pointer rounded-md text-destructive hover:text-destructive hover:bg-destructive/10"
                      onClick={() => signOut({ callbackUrl: '/' })}
                    >
